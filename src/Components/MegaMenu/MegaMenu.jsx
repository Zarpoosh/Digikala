...
const MegaMenu = (props) => {
  const listitems = [
    { title: "موبایل", icon: <BsPhone className="h-4 w-4" /> },
    { title: "کالای دیجیتال", icon: <AiOutlineLaptop className="h-4 w-4" /> },
    { title: "خانه و آشپزخانه", icon: <TbSofa className="h-4 w-4" /> },
    { title: "مد و پوشاک", icon: <RiTShirtLine className="h-4 w-4" /> },
    { title: "کالاهای سوپرمارکتی", icon: <GiMilkCarton className="h-4 w-4" /> },
    {
    ...
    { title: "زیبایی و سلامت", icon: <RiHeartAddLine className="h-4 w-4" /> },
    { title: "ورزش و سفر", icon: <FaCampground className="h-4 w-4" /> },
    { title: "ابزار و لوازم ساختمانی", icon: <BiWrench className="h-4 w-4" /> },
    { title: "خودرو و موتورسیکلت", icon: <FaCarSide className="h-4 w-4" /> },
    { title: "محصولات بومی محلی", icon: <SiIheartradio className="h-4 w-4" /> },
  ];
